        ...
        children: [
          Positioned(
            ...
            child: Transform.translate(
              offset: Offset(translateValueXone.value, translateValueYone.value),
              child: SizedBox(
                height: 300,
                width: 200,
                  ...
                  childWidget: Column(
                    children: [
                      GameScreenCardText(
                        ...
                        myStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(
                              color: Colors.white,
                            ),
                      ),
          ...
          Positioned(
            ...
            right: -100,
            child: Transform.translate(
              offset: Offset(translateValueXtwo.value, translateValueYtwo.value),
              child: SizedBox(
                height: 300,
                width: 200,
                child: GameScreenCard(
