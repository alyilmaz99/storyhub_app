...
class CardPage extends StatefulWidget {
  ...
  @override
  State<CardPage> createState() => _CardPageState(assetImageCardBack: this.assetImageCardBack, assetImageCardFront: this.assetImageCardFront);
}

class _CardPageState extends HowToPageViewModal {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                CountdownTimer(startTimerFrom: 10),
                Container(
